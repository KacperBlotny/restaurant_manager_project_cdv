...
void readFile(string (&mainArrayToRead)[100], int &elementCounter, string fileToRead) {
    int i = 0;
    string temp;
...
void writeToFile(string (&arrayFFHistory)[5], string fileToWrite) {
    string temp;
...
int main() {
    ...
    string mainArrayToRead[100];
    /// Tablica do zapisywania historii w pliku
    string arrayFFHistory[5];
